// MODIFIED 2026-04-27: gate per-menu-update log behind CLAUDE_FRAME_FIX_DEBUG (F-6)
// Inject frame fix before main app loads
const Module = require('module');
const path = require('path');
const originalRequire = Module.prototype.require;

// Gate noisy per-call logs (e.g. setApplicationMenu interception fires
// on every menu update). One-shot startup logs stay unconditional.
const FRAME_FIX_DEBUG = process.env.CLAUDE_DESKTOP_DEBUG === '1'
  || process.env.CLAUDE_FRAME_FIX_DEBUG === '1';
